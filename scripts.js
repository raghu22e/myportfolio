...
document.querySelectorAll('.project h3').forEach(function(item) {
...
const projectElements = documnet.querySelectorAll('.project');
projectElements.forEach((el) => observer.observer(el));